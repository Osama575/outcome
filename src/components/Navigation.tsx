    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-[1140px] mx-auto px-6 h-[72px] flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-4">
          <Button variant="ghost" className="text-white hover:text-[#18D47B]">
            Log In
          </Button>
          <Button className="bg-[#18D47B] hover:bg-[#15C06F] text-[#111519] rounded-full px-6 py-2 text-base font-semibold">
            Sign Up
          </Button>
        </div>
        ...
        <div className="md:hidden bg-[#111519] border-t border-white/10">
          <div className="px-6 py-4 space-y-4">
            ...
            <div className="flex flex-col space-y-2 pt-4">
              <Button variant="ghost" className="text-white hover:text-[#18D47B] w-full">
                Log In
              </Button>
              <Button className="bg-[#18D47B] hover:bg-[#15C06F] text-[#111519] rounded-full w-full">
                Sign Up
              </Button>
            </div>
          </div>
