...
const WhereWeOperate = () => {
  return (
    <section id="where" className="py-20 bg-[#0B0E11]">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
              <div className="aspect-video bg-gradient-to-br from-[#18D47B]/20 to-transparent rounded-xl flex items-center justify-center">
          ...
          <div className="space-y-6">
            ...
            <div className="border-t border-white/10 pt-6">
              <p className="text-white/70 text-sm mb-2">
                ...
                <span className="text-[#18D47B] font-semibold"> 1-800-GAMBLER</span>
              </p>
              <button className="text-[#18D47B] text-sm underline hover:no-underline">
                Full Contest Rules
              </button>
            </div>
          </div>
