                      ...
                      <div className="bg-gradient-to-r from-blue-900/40 to-purple-900/40 rounded-xl p-4 border border-blue-500/30">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-400 text-sm">Points vs Warriors</p>
                          </div>
                        </div>
                        <div className="text-center">
                          <p className="text-2xl font-bold text-white">Over/Under 25.5</p>
                          <p className="text-blue-400 text-sm">Make your pick</p>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {activeStep === 3 && (
                    <div className="space-y-4">
                      ...
                      <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-xl p-6 text-center">
                        ...
                        <p className="text-orange-200 text-sm">LeBron scored 28 points</p>
                      </div>
                    </div>
                  )}
                </div>
